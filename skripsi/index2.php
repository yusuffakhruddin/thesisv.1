...
<script id="pageTmpl" type="text/x-jquery-tmpl">
    ...
    <header class="main-title">
			<h1>Media pembelajaran </br><strong>SMA 1 Sumber Lawang</strong></h1>	
		...
		<div id="flip" class="container">
			...
			<div class="f-page f-cover">
				<div class="cover-elements">
					...
					<h1>Sesuai Kurikulum 2006 <span>Dibuat Oleh <a href="#">Yusuf Fakhruddin</a></span></h1>
					<div class="f-cover-story"><span>Materi Pelajaran</span>Teknologi Informasi Dan Komputer</div>
				</div>

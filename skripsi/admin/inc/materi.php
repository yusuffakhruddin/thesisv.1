...
CKFinder.setupCKEditor( editor, '../' );
	...
	if(isset($_POST['submit']))
	{
		...
		$url	="http://localhost/e-learning/e-learning/admin/uploaded/$name";
		...
		<div class="col-md-12">
	        <div class="panel panel-default">
      		...
      		<?php
                ...
                <textarea id="editor1" name="editor1" value="<?php echo $data_materi['materi']; ?>"></textarea>  </div>
...
CKFinder.setupCKEditor( editor, '../' );
                    ...
                    if(@$_POST['simpan']) {
                        ...
                        mysqli_query($db, "UPDATE tb_materi SET judul = '$judul', materi = '$materi' WHERE id_materi = '$_GET[IDmateri]'") or die ($db->error);
                        echo "<script>window.location='?page=materi';</script>";
                    }
                    ?>
                        <div class="form-group">

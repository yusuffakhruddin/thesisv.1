	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					<form method="post" action="?page=pengajar&action=prosestambah" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" class="form-control" placeholder="yusuf@gmail.com" />
                        </div>
                        <!--<div class="form-group">
                            <label>Alamat *</label>
                        ...
                        <!--<div class="form-group">
                            <label>Website</label>
                            <input type="url" name="web" class="form-control" placeholder="website.com" />
                        </div>-->
                        <div class="form-group">
	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					<form method="post" action="?page=pengajar&action=prosesedit&id=<?php echo $data['id_pengajar']; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" value="<?php echo $data['email']; ?>" class="form-control" placeholder="yusuf@gmail.com" />
                        </div>
                        <div class="form-group">
                            <label>Alamat *</label>
                        ...
                        <div class="form-group">
                            <label>Website</label>
                            <input type="url" name="web" value="<?php echo $data['web']; ?>" class="form-control" placeholder="website.com" />
                        </div>
                        <div class="form-group">
                            <label>Username *</label>

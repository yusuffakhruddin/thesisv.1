        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <!--<li>
                        <a class="<?php if(@$_GET['page'] == 'video') { echo 'active-menu'; } ?>" href="?page=video"><i class="fa fa-qrcode"></i> Video</a>
                    </li>-->
                    <!--<li>
            ...
            <div id="page-inner">
                ...
                if(@$_GET['page'] == '') {
				 ...
				 <footer>
                    ...
                    &copy; Media Pembelajaran Berbasis Website SMA Negeri 1 Sumber Lawang
                </div>
